...
import { CheckCircle, Clock, Brain, Sparkles, Zap, Search, FileText, Target, Edit3, Save, X } from "lucide-react"
...
export function ResearchProgress({ steps, currentAgent, onPlanApprove, onPlanRevise, onSendMessage }: ResearchProgressProps) {
